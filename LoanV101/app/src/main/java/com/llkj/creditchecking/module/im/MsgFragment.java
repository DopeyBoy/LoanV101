package com.llkj.creditchecking.module.im;
...
import com.llkj.creditchecking.base.BaseFragment;
import com.llkj.creditchecking.model.NewsModel;
import com.llkj.creditchecking.module.im.adapter.SystemInfoAdapter;
...
public class MsgFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener ,BaseQuickAdapter.RequestLoadMoreListener{
  ...
  //  @Bind(R.id.refreshLayout)
    ...
    private SystemInfoAdapter newsAdapter;
    private boolean isInitCache = false;
    List<NewsModel.ContentList> dataList =new ArrayList<>();
    ...
    protected void initData() {
        ...
        newsAdapter = new SystemInfoAdapter(null);
        newsAdapter.openLoadAnimation(BaseQuickAdapter.SCALEIN);
        newsAdapter.isFirstOnly(false);
        recyclerView.setAdapter(newsAdapter);
        for (int i=0;i<10;i++){
            NewsModel.ContentList item = new NewsModel.ContentList();
            item.title = "title"+i;
            dataList.add(item);
        }
        newsAdapter.setNewData(dataList);
...
//                .execute();
        ...
        /***
         * new NewsCallback<NewsResponse<NewsModel>>() {
        @Override
