package com.llkj.creditchecking.widget;
	...
	public static class Builder {
		...
		public CustomDialog create() {
			...
			if (title == null || title.trim().length() == 0) {
				((TextView) layout.findViewById(R.id.message_tip))
			...
			if (message != null) {
				((TextView) layout.findViewById(R.id.message_tip)).setText(message);
			} else if (contentView != null) {
				// if no message set
				// add the contentView to the dialog body
				((RelativeLayout) layout.findViewById(R.id.message)).removeAllViews();
				((RelativeLayout) layout.findViewById(R.id.message)).addView(contentView, new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT));
			}
