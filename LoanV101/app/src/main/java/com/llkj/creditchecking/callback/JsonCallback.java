package com.llkj.creditchecking.callback;
import com.google.gson.stream.JsonReader;
import com.llkj.creditchecking.model.LzyResponse;
import com.llkj.creditchecking.model.SimpleResponse;
import com.llkj.creditchecking.utils.ConvertUtils;
...
public abstract class JsonCallback<T> extends AbsCallback<T> {
    ...
    public T convertSuccess(Response response) throws Exception {
        ...
        if (rawType == Void.class) {
            ...
            SimpleResponse simpleResponse = ConvertUtils.fromJson(jsonReader, SimpleResponse.class);
            response.close();
            //noinspection unchecked
            return (T) simpleResponse.toLzyResponse();
        } else if (rawType == LzyResponse.class) {
            //有数据类型，表示有data
            LzyResponse lzyResponse = ConvertUtils.fromJson(jsonReader, type);
            response.close();
            ...
            if (code == 0) {
                ...
                throw new IllegalStateException("错误:"+lzyResponse.msg);
            } else if (code == 403	) {
